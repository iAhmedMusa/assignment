...
export default function Doctor(props: DoctorProps): JSX.Element {
  ...
  return (
    <div
      ...
      className={`w-[350px] lg:w-[320px] 2xl:w-[350px] h-[436px] bg-bg-white rounded-lg shadow-lg relative cursor-pointer`}
    >
      ...
      <div className="card-body items-center text-center leading-4">
        ...
        {!weekDaysSchedules.length && <div className="text-cente py-4">No Schedules yet</div>}
